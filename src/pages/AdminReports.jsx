            ...
            <div style={{ flex: 1, height: 20, background: 'var(--bg-secondary)', borderRadius: 6, overflow: 'hidden' }}>
              <div style={{
                ...
                background: color === 'blue'
                  ? 'linear-gradient(135deg, rgba(200,241,53,0.15) 0%, rgba(200,241,53,0.05) 100%)'
                  : 'linear-gradient(135deg, rgba(200,241,53,0.15) 0%, rgba(200,241,53,0.05) 100%)',
                borderRadius: 6,
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      <span style={{
                        ...
                        height: 22,
                        borderRadius: 6,
                        background: i === 0 ? 'rgba(200,241,53,0.15)' : i === 1 ? 'rgba(148,163,184,0.12)' : i === 2 ? 'rgba(205,124,47,0.12)' : 'var(--bg-card)',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        fontSize: 10,
