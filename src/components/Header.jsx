    ...
    <header className="app-header">
      ...
      <div style={{ display:'flex', alignItems:'center', gap:8, flex:1, justifyContent:'center' }}>
        <div className="header-logo-icon">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#05070A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={{ display:'flex', alignItems:'center', gap:14 }}>
        <div style={{ position:'relative', cursor:'pointer', display:'flex', alignItems:'center' }} onClick={() => setShowNotificacoes(true)}>
          ...
          {notificacoes.filter(n => !n.lida).length > 0 && (
            <span style={{ position:'absolute', top:-2, right:-2, background:'var(--accent)', color:'#05070A', fontSize:'8px', fontWeight:800, width:14, height:14, borderRadius:'50%', display:'flex', alignItems:'center', justifyContent:'center', border:'2px solid var(--bg-primary)' }}>
