  ...
  <BgWrapper>
    <style>{`
      @keyframes floatBall1 {
        ...
        50% { transform: translate(40px, 50px) rotate(60deg); }
      }
      @keyframes floatBall2 {
        0%, 100% { transform: translate(40px, 30px) rotate(0deg) scale(0.8); }
        50% { transform: translate(-40px, -50px) rotate(-60deg) scale(0.9); }
      }
    `}</style>
    <svg viewBox="0 0 800 800" width="100%" height="100%" preserveAspectRatio="xMidYMid slice">
      <g style={{ animation: 'floatBall1 15s ease-in-out infinite' }} transformOrigin="200px 200px">
      ...
      <g style={{ animation: 'floatBall2 20s ease-in-out infinite' }} transformOrigin="600px 600px">
  ...
  <BgWrapper>
    <style>{`
      ...
      @keyframes rankShootBall {
        ...
        40% { transform: translate(30px, -150px); opacity: 1; }
        60% { transform: translate(150px, -50px) scale(0.6); opacity: 0; }
    ...
    <svg viewBox="0 0 600 600" width="100%" height="100%">
      <g strokeWidth="5" fill="none" strokeLinecap="round" strokeLinejoin="round" transform="translate(150, 150) scale(1.6)">
        ...
        <g style={{ animation: 'rankShootArm 4s cubic-bezier(0.45, 0, 0.55, 1) infinite' }} transformOrigin="100px 100px">
          <path d="M100 100 L70 120 L70 150" stroke="var(--text-primary)" />
          <g style={{ animation: 'rankShootBall 4s cubic-bezier(0.2, 0, 0, 1) infinite' }}>
  ...
  <BgWrapper>
    <style>{`
      @keyframes dribbleBall {
        ...
        50% { transform: translateY(70px) scaleX(1.3) scaleY(0.7); }
      }
    ...
    <svg viewBox="0 0 600 600" width="100%" height="100%">
      <g strokeWidth="6" fill="none" strokeLinecap="round" strokeLinejoin="round" transform="translate(150, 150) scale(1.5)">
        ...
        <g style={{ animation: 'dribbleArm 0.7s cubic-bezier(0.45, 0, 0.55, 1) infinite' }} transformOrigin="100px 85px">
          <path d="M100 85 L130 120 L120 160" stroke="var(--text-primary)" />
        </g>
        <g style={{ animation: 'dribbleBall 0.7s cubic-bezier(0.45, 0, 0.55, 1) infinite' }} transformOrigin="120px 175px">
  ...
  <BgWrapper>
    <style>{`
      ...
      @keyframes courtBallBounce {
        ...
        50% { transform: translateY(180px) scale(1.4, 0.6); }
      }
    ...
    <svg viewBox="0 0 800 800" width="100%" height="100%">
      ...
      <g style={{ animation: 'courtBallMove 5s linear infinite alternate' }}>
        <g style={{ animation: 'courtBallBounce 0.9s cubic-bezier(0.45, 0, 0.55, 1) infinite' }} transformOrigin="400px 500px">
  ...
  <BgWrapper>
    ...
    <svg viewBox="0 0 600 600" width="100%" height="100%">
      <g stroke="var(--text-primary)" strokeWidth="6" fill="none" strokeLinecap="round" strokeLinejoin="round" 
         style={{ animation: 'trophyFloatBig 5s ease-in-out infinite' }} transformOrigin="300px 300px">
...
export const StatsBackground = () => (
  <BgWrapper>
    <style>{`
      @keyframes barGrow1 { 0%, 100% { transform: scaleY(0.2); } 50% { transform: scaleY(0.9); } }
      @keyframes barGrow2 { 0%, 100% { transform: scaleY(0.6); } 50% { transform: scaleY(0.3); } }
      @keyframes barGrow3 { 0%, 100% { transform: scaleY(0.4); } 50% { transform: scaleY(0.8); } }
      @keyframes lineChartPulse { 0%, 100% { stroke-dashoffset: 400; opacity: 0.5; } 50% { stroke-dashoffset: 0; opacity: 1; } }
    ...
    <svg viewBox="0 0 800 800" width="100%" height="100%">
      <g stroke="var(--text-primary)" fill="none" opacity="0.6">
        <rect x="250" y="300" width="40" height="300" strokeWidth="4" transformOrigin="250px 600px" style={{ animation: 'barGrow1 4s ease-in-out infinite' }} />
        <rect x="350" y="300" width="40" height="300" strokeWidth="4" transformOrigin="350px 600px" style={{ animation: 'barGrow2 5s ease-in-out infinite' }} />
        <rect x="450" y="300" width="40" height="300" strokeWidth="4" transformOrigin="450px 600px" style={{ animation: 'barGrow3 4.5s ease-in-out infinite' }} />
        <rect x="550" y="300" width="40" height="300" strokeWidth="4" transformOrigin="550px 600px" style={{ animation: 'barGrow1 5.5s ease-in-out infinite' }} />
        
        <path d="M150 550 L270 420 L370 480 L470 320 L570 380 L690 200" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" 
              strokeDasharray="400" style={{ animation: 'lineChartPulse 8s ease-in-out infinite' }} stroke="var(--accent)" />
